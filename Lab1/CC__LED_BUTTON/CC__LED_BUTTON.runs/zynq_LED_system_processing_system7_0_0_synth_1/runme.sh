...
HD_PWD='/home/chris/Repos/EmbeddedSystems/CC__LED_BUTTON/CC__LED_BUTTON.runs/zynq_LED_system_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_LED_system_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_LED_system_processing_system7_0_0.tcl
