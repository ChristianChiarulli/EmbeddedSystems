...
HD_PWD='/home/chris/Repos/EmbeddedSystems/CC__LED_BUTTON/CC__LED_BUTTON.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_LED_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_LED_system_wrapper.tcl -notrace
