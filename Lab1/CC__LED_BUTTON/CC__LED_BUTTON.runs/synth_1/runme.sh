...
HD_PWD='/home/chris/Repos/EmbeddedSystems/CC__LED_BUTTON/CC__LED_BUTTON.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_LED_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_LED_system_wrapper.tcl
