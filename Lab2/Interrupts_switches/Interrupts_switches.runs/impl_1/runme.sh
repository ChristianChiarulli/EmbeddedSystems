...
HD_PWD='/home/chris/Repos/EmbeddedSystems/Lab2/Interrupts_switches/Interrupts_switches.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interrupt_switch_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interrupt_switch_design_wrapper.tcl -notrace
