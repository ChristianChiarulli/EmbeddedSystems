...
HD_PWD='/home/chris/Repos/EmbeddedSystems/Lab2/Interrupts_switches/Interrupts_switches.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interrupt_switch_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interrupt_switch_design_wrapper.tcl
