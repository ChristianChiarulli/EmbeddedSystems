...
HD_PWD='/home/chris/Repos/EmbeddedSystems/Lab2/Interrupts_switches/Interrupts_switches.runs/interrupt_switch_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interrupt_switch_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interrupt_switch_design_auto_pc_0.tcl
