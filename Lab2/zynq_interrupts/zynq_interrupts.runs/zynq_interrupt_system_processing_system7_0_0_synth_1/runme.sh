...
HD_PWD='/home/chris/Repos/EmbeddedSystems/Lab2/zynq_interrupts/zynq_interrupts.runs/zynq_interrupt_system_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupt_system_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_processing_system7_0_0.tcl
