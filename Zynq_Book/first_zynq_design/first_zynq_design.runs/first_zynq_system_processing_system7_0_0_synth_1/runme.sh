...
HD_PWD='/home/chris/Repos/EmbeddedSystems/Zynq_Book/first_zynq_design/first_zynq_design.runs/first_zynq_system_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_zynq_system_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_zynq_system_processing_system7_0_0.tcl
